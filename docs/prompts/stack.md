...
_"Com base nos requisitos, temos um sistema que precisa atender múltiplos tipos de usuários, com back-office e interface pública, além de escalabilidade futura. Você prefere começar com uma arquitetura mais simples e evoluir, ou já quer adotar uma divisão entre back-end e front-end desde o início?"_
